...
_TASK_TYPES = ["review", "maintenance"]   # this node's self-described capability
...
class HoneCoreClient:
    ...
    def get_blob(self, root_message_id: str) -> bytes:
        ...
        r = self._request("GET", f"/v1/patchsets/{root_message_id}/blob")
        r.raise_for_status()
        return r.content
